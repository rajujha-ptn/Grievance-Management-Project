...
export function GlobalSlaPolicyCard() {
    ...
    return (
        <div className='p-6 pb-0 mb-6 bg-white border border-gray-200 rounded-xl '>
            <div className="bg-white rounded-xl shadow-sm mb-6 border border-[#000000]/10 shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.05),0px_2px_4px_-1px_rgba(0,0,0,0.03)] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 rounded-xl">
                ...
                <div className="px-6 py-6 border-t border-gray-100 flex justify-end bg-white rounded-b-xl">
                    <button className="flex items-center gap-2 bg-[#16A34A] hover:bg-[#10883c] text-white px-6 py-2.5 rounded-lg font-bold transition-colors text-sm">
